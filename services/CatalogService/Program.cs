...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "Reservas - Catalog API",
        Version = "v1",
        Description = "Gestion de sucursales, servicios, recursos y horarios del sistema de reservas."
    });
...
builder.Services.AddAuthorizationBuilder()
    ...
    .AddPolicy("TenantAdminOnly", policy => policy
        .RequireAuthenticatedUser()
        .RequireClaim("user_id")
        .RequireClaim("tenant_id")
...
app.UseSwaggerUI(options =>
{
    ...
    options.DocumentTitle = "Reservas - Catalog API";
});
